...
def main(n_colors_or_rgb_arr, isopyramid_start_colors, n_neighbour_colors, n_close_dE_colors, min_nci_dE=10.0):
    ...
    if isinstance(n_colors_or_rgb_arr, int):
        ...
        ref_dE = tuple(sortall.argsort_rgb_arr_keys(in_rgb_arr[:1])[0])
...
if __name__ == "__main__":
    ...
    usage = """Usage: python generate1.py <palette size or image> <pyramid level1 colors> <next-level-neighbour-colors> <next-level-closest-de-colors>"""
    # try:
