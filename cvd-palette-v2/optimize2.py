...
if __name__ == "__main__":
    usage = """Usage: python optimize2.py <palette image> [min difference]"""
    try:
    ...
    out_rgb_arr = main(in_rgb_arr, min_nci_dE)

    out_img_path = in_img_path.with_suffix(f'.opt' + in_img_path.suffix)
